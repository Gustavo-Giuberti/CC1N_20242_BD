...
AM_ID_ALUNO INT,
AM_ID_MODALIDADE INT, 
PRIMARY KEY (AM_ID_ALUNO,AM_ID_MODALIDADE),
CONSTRAINT AM_FK_ID_ALUNO FOREIGN KEY (AM_ID_ALUNO) 
REFERENCES ALUNOS (ID_ALUNO),
CONSTRAINT AM_FK_ID_MODALIDADE FOREIGN KEY (AM_ID_MODALIDADE)
REFERENCES MODALIDADES (ID_MODALIDADE)
);
